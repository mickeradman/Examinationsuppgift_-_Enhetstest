        ...
        <section className='booking-info'>
            ...
            <form className="booking-info__details">
                <section className='booking-info__when'>
                    <Input customId="when" label="Date" type="date" customClass="booking-info__date" 
                    name="when" handleChange={ updateBookingDetails } />
                    <Input customId="time" label="Time" type="text"
                    name="time" handleChange={ updateBookingDetails } />
                </section>
                <Input customId="people" label="Number of awesome bowlers" type="number" customClass="booking-info__who"
                name="people" handleChange={ updateBookingDetails } />
                <Input customId="lanes" label="Number of lanes" type="number" customClass="booking-info__lanes"
